...
type Tor struct {
	...
	Grpc              bool   `long:"grpc" description:"Automatically set up a hidden service for the gRPC API"`
	Rest              bool   `long:"rest" description:"Automatically set up a hidden service for the REST API"`
